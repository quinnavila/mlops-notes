...
kinesis_client = boto3.client("kinesis", verify=False, endpoint_url=kinesis_endpoint)
endpoint_url = kinesis_client.meta.endpoint_url
print(f"Kinesis endpoint URL: {endpoint_url}")
